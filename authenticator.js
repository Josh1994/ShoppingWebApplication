...
// Create the oauth object for accessing Twitter. Uses twitter's API configuration
var oauth = new OAuth(
...
The first function requests a request token, and stores in http cookies and sends them to the client
(this ensures stateless for REST), HTTPOnly ensures that cookies should not be accessible using
javascript to protect against cross-site scripting.

The second function, we access the cookies we set earlier using direct.cookies object.
*/
